...
public class CaptureCommand implements ICommand {
    ...
    public CaptureCommand(Piece capturerPiece, Piece capturedPiece, CaptureHandler captureHandler) {
    ...
    public CommandResult execute() {
        ...
        result.setMovement(fromPosition, capturedPiece.getPosition(), 0, direction);
        return result;
    }
}
