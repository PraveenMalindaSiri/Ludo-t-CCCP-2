...
public final class GameSnapshot {
    ...
    private GameSnapshot(int round, List<PlayerView> players,
                         boolean mysteryActive, int mysteryPosition,
    ...
    public static GameSnapshot from(int round, List<Player> players,
        ...
        return new GameSnapshot(round, views,
                mysteryManager.isActive(), mysteryManager.getPosition(),
                mysteryManager.getRoundsRemaining());
    }

    public int getRound() { return round; }
    public List<PlayerView> getPlayers() { return players; }
    public boolean isMysteryActive() { return mysteryActive; }
    public int getMysteryPosition() { return mysteryPosition; }
    public int getMysteryRoundsRemaining() { return mysteryRoundsRemaining; }
    ...
    public static final class PlayerView {
        ...
        private PlayerView(String color, int boardCount, int baseCount,
        ...
        private static PlayerView from(Player player) {
            ...
            for (Piece piece : player.getPieces()) {
                pieces.add(new PieceView(
                        piece.getName(), piece.getFullName(), piece.positionLabel()));
            }
            return new PlayerView(player.getColor(),
                    player.getPiecesOnBoard().size(),
                    player.getPiecesInBase().size(), pieces);
        }

        public String getColor() { return color; }
        public int getBoardCount() { return boardCount; }
        public int getBaseCount() { return baseCount; }
        public List<PieceView> getPieces() { return pieces; }
    }
